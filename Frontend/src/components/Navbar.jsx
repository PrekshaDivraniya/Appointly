        ...
        <div className='flex items-center gap-4'>
            {
                ...
                : <button onClick={()=>navigate('/login')} className='bg-primary border-none outline-none text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>
            }
            ...
            <div className={` ${showMenu ? 'fixed w-full':'h-0 w-0'} md:hidden right-0 bottom-0 top-0 z-20 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 font-medium text-lg'>
