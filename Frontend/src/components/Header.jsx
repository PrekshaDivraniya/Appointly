...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        {/* .........left side .......*/}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-28 m-auto md:py-{10vw} md:mb-{-30px}'>
            ...
            <a className='flex items-center gap-2 bg-white py-3 px-9 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#speciality">
